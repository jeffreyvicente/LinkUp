        ...
        <div className="container">
          <div className="row">
            <div className="col-sm-4">
              ...
              <div>
                <Button
                  className="btn btn-primary w-50 event-create"
                  onClick={handleShow}
                >
                  Create New Event
                </Button>
            ...
            <div className="col-sm-8">
              <div className="currentEventSection">
                ...
                <div>
                  ...
                  {user && user.events && Array.isArray(user.events) ? (
                    user.events.map((event, index) => (
                      <Link to={`/events/${event._id}`} key={index}>
                        <button
                          className="list-group-item list-group-item-action current-event"
                          type="button"
                        >
                          {event.title}
                        </button>
